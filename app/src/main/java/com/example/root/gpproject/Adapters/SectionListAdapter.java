package com.example.root.gpproject.Adapters;
...
import com.example.root.gpproject.R;
...
public class SectionListAdapter extends RecyclerView.Adapter<SectionListAdapter.SingleItemRowHolder> {
    ...
    public SectionListAdapter(Context context, ArrayList<SingleItemModel> itemsList) {
